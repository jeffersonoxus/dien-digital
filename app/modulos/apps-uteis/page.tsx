...
export default function ModuloAppsUteis() {
  ...
  if (concluido) {
    return (
      <div className="h-screen w-full bg-gradient-to-br from-orange-600 to-red-600 flex items-center justify-center p-4">
        <motion.div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 text-center max-w-md w-full">
          ...
          <button
            ...
            className="bg-white text-orange-600 px-6 py-3 rounded-full font-bold w-full"
          >
            Voltar ao Início
          </button>
        </motion.div>
  ...
  return (
    <div className="h-screen w-full bg-gradient-to-br from-orange-600 to-red-600 flex flex-col">
      <div className="bg-black/20 backdrop-blur-md px-4 py-3">
        ...
        <h1 className="text-white font-bold text-center mt-2">Apps Úteis do Dia a Dia</h1>
      </div>
