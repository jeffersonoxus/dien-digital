      ...
      <div className="h-screen w-full bg-gradient-to-br from-slate-900 to-slate-800 flex items-center justify-center p-4">
        ...
        >
          ...
          <button
            ...
            className="bg-white text-slate-800 px-6 py-3 rounded-full font-bold w-full"
          >
            Voltar ao Início
          </button>
        </motion.div>
  ...
  return (
    <div className="h-screen w-full bg-gradient-to-br from-slate-900 to-slate-800 flex flex-col">
      <div className="bg-black/20 backdrop-blur-md px-4 py-3">
        ...
        <h1 className="text-white font-bold text-center mt-2">Segurança Digital</h1>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="text-center">
          ...
          <button
            ...
            className="bg-white/20 backdrop-blur-sm px-8 py-3 rounded-full text-white font-bold hover:bg-white/30 transition-colors"
          >
            Marcar como Lido
          </button>
        </div>
